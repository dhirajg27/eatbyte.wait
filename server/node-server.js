...
const statistJsonServer = jsonServer.create();
const router = jsonServer.router('db.json');
const middlewares = jsonServer.defaults();

statistJsonServer.use(middlewares);
statistJsonServer.use('/api', router);
statistJsonServer.listen(4041,  ()=> {
  winston.info('JSON Server is running at 4041');
});
